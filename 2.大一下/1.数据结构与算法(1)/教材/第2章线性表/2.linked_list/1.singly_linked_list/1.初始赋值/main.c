/*
* Copyright (c) 2019,JGX is the most handsome man in NCEPU
* All rights reserved.
*
* 文件名称: main.c
* 文件标识: 见README.md
...
int main(int argc, char *argv[])
{
    ...
    printf("|                    单向链表                      |\n");
    printf("|                              计算001班 贾皋肖   |\n");
    printf("|       JGX is the most handsome man in NCEPU      |\n");
    printf("---------------------------------------------------\n");
    LinkList L;
    ...
    printf("\n------------------location--------------------------\n");
    i = linklist_location(L, "JGX");
    if(0 != i){
        printf("You want locat element 'JGX' is %d \n", i);
    }else{
        printf("Can't location\n");
    }
    char s[50];
    strcpy(s, "JGX is the most hangsome man in NCEPU");
